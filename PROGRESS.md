...
- [x] Vitest: 41 test verdi (runner dentro Electron per l'ABI di better-sqlite3)
...
## FASE 2 — AI (impalcatura, modalità Esperto) — NON INIZIATA
- [ ] Auto-Cue assistito (madmom/aubio/essentia + allin1), UI waveform human-in-the-loop
- [ ] Dedup per fingerprint (fpcalc già nel sidecar: comando `fingerprint` pronto)
- [ ] Relocator per fingerprint
- [ ] Auto-Tagger (Discogs/MusicBrainz, solo query testuali, rate-limit+retry)
- [ ] Stems (Demucs) on-demand cancellabile
- [ ] Scrittura ID3 su copia con rollback verificato (Serato)
